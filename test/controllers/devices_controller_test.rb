...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { name: @device.name, type_of_device: @device.type_of_device } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { name: @device.name, type_of_device: @device.type_of_device } }
